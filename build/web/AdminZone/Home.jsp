  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-5"><br><br><br><img class="img img-circle img-thumbnail" style="border:1px solid red;" src="../img/tifin1.jpeg"></div>
                <div class="col-sm-1"></div>
                
                <div class="col-sm-4">
                    <br><br><br><br><br><p style="font-family:New Time roman; font-size: 16px; text-align: justify">
                         ...
                         <br>We must notice the service of all Distributer and We also Noticed the feedback of customer.
                    </p>
                </div>
                    <div class="col-sm-1"></div>
            </div>
