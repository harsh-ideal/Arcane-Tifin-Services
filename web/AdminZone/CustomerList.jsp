        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="col-sm-8" style="margin-top: 3%">
                    <h3 class='text-center text-warning'>View Customer List</h3>
                    ...
                    <table class='table table-responsive table-bordered' id="example">
                        <thead style="background: orangered;color: white">
                            <tr>
                                ...
                                <th>Pin_code</th><th>address</th><th>Date</th><th>Block/Delete</th>
                            </tr>
                        </thead>
                        <tbody>
                    <%
                    ...
                    while(rs.next())
                    {
                        ...
                        <tr>
                            ...
                            <td>
    <a href="Enquirydelete.jsp?del=<%=rs.getString("name")%>"> 
